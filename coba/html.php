                            ...
                            <table align='center' border='0' cellpadding='0' cellspacing='0' width='100%' style='max-width:600px;'>
                                ...
                                <tr>
                                        ...
                                        if($jenis_pembayaran=='COD'){
                                         echo"<td align='center' style='font-family: Open Sans, Helvetica, Arial, sans-serif; font-size: 16px; font-weight: 400; line-height: 24px; padding-top: 25px;'> <img src='$domain\/img/bank/cod.png' width='125' height='120' style='display: block; border: 0px;' /><br>";
                                            echo "<h4 style='font-size: 20px; font-weight: 800; line-height: 36px; color: #333333; margin: 0;'>(Akan kami hubungi segera untuk proses lebih lanjut) </h4>
                                            ";
                                        }else{
                                            echo"<td align='center' style='font-family: Open Sans, Helvetica, Arial, sans-serif; font-size: 16px; font-weight: 400; line-height: 24px; padding-top: 25px;'> <img src='$domain\/img/bank/$foto_bank' width='125' height='120' style='display: block; border: 0px;' /><br>";
                                            echo "<h4 style='font-size: 20px; font-weight: 800; line-height: 36px; color: #333333; margin: 0;'> <?=$jenis_pembayaran;?> - <?=$no_rekening;?> a/n <?=$nm_rekening;?> </h4>
                                            ";
                                        }
                                ...
                                <tr>
                                    <td align='left' style='padding-top: 20px;'>
                                        <table cellspacing='0' cellpadding='0' border='0' width='100%'>
                                            ...
                                            ?>
                                            <tr>
                                                <td width='75%' align='left' style='font-family: Open Sans, Helvetica, Arial, sans-serif; font-size: 16px; font-weight: 400; line-height: 24px; padding: 5px 10px;'> <?= $f_item['nm_barang'];?> (<?= $f_item['qty'];?>) </td>
                                                <td width='25%' align='left' style='font-family: Open Sans, Helvetica, Arial, sans-serif; font-size: 16px; font-weight: 400; line-height: 24px; padding: 5px 10px;'> Rp. <?= $f_item['harga_total'];?> </td>
                                            </tr>
                                            <?php
                                            }?>
                                            <?php
                                            ...
                                            $voucher =  $h_harga_awal - $harga_total1;
                                            ...
                                            <table align='left' border='0' cellpadding='0' cellspacing='0' width='100%' style='max-width:300px;'>
                                                <tr>
                                                    <td align='left' valign='top' style='font-family: Open Sans, Helvetica, Arial, sans-serif; font-size: 16px; font-weight: 400; line-height: 24px;'>
                                                        ...
                                                        <p><i><strong>Bpk/Ibu (<?=$nm_pembeli;?>)</strong></i><br>Nomor HP : <?=$hp;?><br>Email: <?=$email;?></p>
                                                    </td>
                                                </tr>
                                            </table>
                                        </div>

                            ...
                            <table align='center' border='0' cellpadding='0' cellspacing='0' width='100%' style='max-width:600px;'>
                                ...
                                <tr>";
                                        if($jenis_pembayaran=='COD'){
                                         $message .= "<td align='center' style='font-family: Open Sans, Helvetica, Arial, sans-serif; font-size: 16px; font-weight: 400; line-height: 24px; padding-top: 25px;'> <img src='$domain\/img/bank/cod.png' width='125' height='120' style='display: block; border: 0px;' /><br>";
                                         ...
                                         $message .="<td align='center' style='font-family: Open Sans, Helvetica, Arial, sans-serif; font-size: 16px; font-weight: 400; line-height: 24px; padding-top: 25px;'> <img src='$domain\/img/bank/$foto_bank' width='125' height='120' style='display: block; border: 0px;' /><br>";

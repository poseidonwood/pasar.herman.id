           ...
           <a href="#" class="btn btn-info" data-toggle="modal" data-target="#ltsortir"><i class="fas fa-sort"></i></a>-->
            ...
            <div class="card card-info">
              <div class="card-header">
                <h3 class="card-title">Posting Product</h3>                
              </div>
              <div class="card-body">
            ...
            <div class="card card-light card-tabs">
              <div class="card-header p-0 pt-1">
                <ul class="nav nav-tabs" id="custom-tabs-one-tab" role="tablist">
                  <li class="nav-item">
                    <a class="nav-link active" id="custom-tabs-one-home-tab" data-toggle="pill" href="#custom-tabs-one-home" role="tab" aria-controls="custom-tabs-one-home " aria-selected="true"><i class ="fas fa-shopping-cart"></i>&nbsp;Product Post</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" id="custom-tabs-one-profile-tab" data-toggle="pill" href="#custom-tabs-one-profile" role="tab" aria-controls="custom-tabs-one-profile" aria-selected="false"><i class ="fas fa-tags"></i>&nbsp;Product Promo</a>
                  </li>
                </ul>
              </div>
              <div class="card-body">
                ...
                <div class="input-group-prepend">
                    <span class="input-group-text"><i class="fas fa-cloud">&nbsp;</i></span>
                      ...
                      <div class="input-group-append">
                        <span class="input-group-text bg-success" id="">*Ukuran foto 600px*600px atau 1:1</span>
                      </div>
                    </div>
          <!--      <div class="input-group mb-3">
                  <div class="input-group-prepend">

        ...
        <div class="col-12">
         ...
         <!--   <div class="card-header">
          <!--    <a href="../../pages/forms/keluar.php" class="btn btn-success"><i class="fas fa-arrow-left"></i>&nbsp;</i>Kembali</a>&nbsp;
            ...
            <!-- /.card-header -->
            <div class="card-body">
            <center><h3>List Transaksi Per <?php $tgl=$_POST['tanggal1']; echo $tgl;?></h3></center></br>
                ...
                while($d = mysqli_fetch_array($data)){
                  ...
                  <tr>
                    ...
                    <a href="../../pages/forms/keluar-update.php?id=<?php echo $d['id_transaksi'];?>" class="btn btn-info"><i class="fas fa-check"></i></a>
                      <a href="../../proses/hapus-keluar.php?id=<?php echo $d['id_transaksi']; ?> " class="btn btn-danger" ><i class="fas fa-trash" onclick="return confirm('Anda yakin mau menghapus item ini ?')"></i></a>
                    </td>
                  </tr>
                  <?php $total += $d['total'];
                  $laba += $d['untung'];
